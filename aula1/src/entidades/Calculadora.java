...
public class Calculadora {
	...
	public void divisao(Integer valor1, Integer valor2) {
		...
		if (valor2 <= 0) {
			...
			System.out.println("Divisão de " + valor1 + " e " + valor2 + " = " + (valor1 / valor2));
		}
	}

	public void subtracao(Integer valor1, Integer valor2) {

		System.out.println("Subtração de " + valor1 + " e " + valor2 + " = " + (valor1 - valor2));

	}

	public void multiplicacao(Integer valor1, Integer valor2) {

		System.out.println("Multiplicação de " + valor1 + " e " + valor2 + " = " + (valor1 * valor2));
